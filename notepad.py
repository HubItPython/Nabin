def note():
    from tkinter import Tk,Label,Button,Entry,Frame,Text,Menu,END,messagebox,filedialog,StringVar,font,LabelFrame,RIDGE
    ...
    def show_options():
        ...
        menu.add_command(label="New file",accelerator="ctr+n",command=show_options)
    ...
    def edit():
        ...
        menu.add_command(label="Timne/Date",accelerator="F5",command=paste)
